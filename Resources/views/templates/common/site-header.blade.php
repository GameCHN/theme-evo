        ...
        <div class="container sp-cont">
            ...
            <div class="header-right">
                <div class="user-login-panel">
                    <a class="user-login-btn" href="{{ Lawyer::is_public() ? _url('lawyer-profile') : wp_logout_url(_url('lawyer-registration') ) }}">{{ __( Lawyer::is_public() ? '我的资料' : '律师登记') }}</a>
                    <a href="#" class="user-login-btn hide" data-toggle="modal" data-target="#loginModal"><i class="icon-profile"></i></a>
                </div>

                {{ wp_nav_menu( array(
                    'theme_location' => 'person-menu',
                    'container' => 'div',
                    'container_class' => 'topnav dd-menu',
                    'menu_class' => 'top-navigation sf-menu',
                 ))
                 }}
                @if(0)
                    <div class="topnav dd-menu">
                        <ul class="top-navigation sf-menu">
                            ...
                            @if(!is_user_logged_in())
                                {{-- wp_register()  --}}
                                <li>
                                    <a href="{{site_url('/wp-login.php?action=register&redirect_to=/wp-login.php?redirect_to=' . get_permalink())}}"
                                            title="Register">{{__('会员注册')}}</a>
                                </li>
                                <li>
                                    <a href="{{wp_login_url('http://'.$_SERVER['SERVER_NAME'].$_SERVER["REQUEST_URI"])}}">{{__('登录')}}</a>
                                </li>
                            @else
                                <li class="hide">
                                    <a href="/sns/ucenter/rankverify">{{ __('我是律师') }}</a>
                                </li>
                                <li>
                                    <a href="{{ wp_logout_url($_SERVER['REQUEST_URI']) }}">{{ __('退出') }}</a>
                                </li>
            ...
            @if(0)
                <nav class="main-navigation dd-menu toggle-menu" role="navigation">
                    <ul class="sf-menu">
                        ...
                        <li>
                            <a href="javascript:void(0)">{{ ot_get_option('menu_contact_title',__('律师联络')) }}</a>
                            <ul class="dropdown">
                                ...
                                @else
                                    ...
                                    <li>
                                        <a href="dealers-search-results.html">Dealer Search Results</a>
                                    </li>
                                    <!--{/demo}-->
                                @endif
                            </ul>
                                                    ...
                                                    <ul class="make-widget">
                                                        <li class="item">
                                                            <a href="results-list.html">
                                                                <img src="http://placehold.it/100x100&amp;text=IMAGE+PLACEHOLDER" alt=""></a>
                                                        </li>
                                                        <li class="item">
                                                            <a href="results-list.html">
                                                                <img src="http://placehold.it/100x100&amp;text=IMAGE+PLACEHOLDER" alt=""></a>
                        ...
                        @endif
                        <li>
                            <a href="javascript:void(0)">{{ot_get_option('menu_laws_title',__('海内外法律'))}}</a>
                            <ul class="dropdown">
                        ...
                        <li>
                            <a href="javascript:void(0)">{{ot_get_option('menu_news_title',__('资讯动态'))}}</a>
                            <ul class="dropdown">
                        ...
                        <li>
                            <a href="javascript:void(0)">{{ot_get_option('menu_lawyers_title',__('合作律师'))}}</a>
                            <ul class="dropdown">
                        ...
                        <li>
                            <a href="javascript:void(0)">{{ot_get_option('menu_member_title',__('会员服务'))}}</a>
                            <ul class="dropdown">
