                    ...
                    <div id="undefined-sticky-wrapper" class="sticky-wrapper" style="height: 405px;">
                        <div class="users-sidebar tbssticky">
                            @if(is_user_logged_in())
                                <ul class="list-group">
                                    <li class="list-group-item {{ $leftact['profile']}}" active><span class="badge hide">5</span>
                                        <a href="{{ _url(Lawyer::is_public() ? 'lawyer-profile' : 'profile') }}">
                                            <i class="fa fa-home"></i> {{ __(Lawyer::is_public() ? '律师资料' : '个人信息') }}</a>
                                    </li>
                                    <li class="hide list-group-item {{ $leftact['lawyer-profile']}}"><span class="badge hide">5</span>
                                        <a href="/lawyer-profile"><i class="fa fa-folder-o"></i> {{ __('律师资料') }}</a>
                                    </li>
                                    <li class="hide list-group-item {{ $leftact['user-posts']}}"><span class="badge ">12</span>
                                        <a href="/user-posts"><i class="fa fa-star-o"></i> {{ __('我的帖子') }}</a>
                                    </li>
                                    <li class="hide list-group-item {{ $leftact['user-reply']}}"><span class="badge ">12</span>
                                        <a href="/user-reply"><i class="fa fa-plus-square-o"></i> {{ __('我的回复') }}</a>
                                    </li>
                                    ...
                                    <li class="list-group-item">
                                        <a href="user-dashboard-settings.html"><i class="fa fa-cog"></i> Account Settings</a>
                                    </li>
                                    <li class="list-group-item">
                                        <a href="javascript:void(0)"><i class="fa fa-sign-out"></i> Log Out</a>
                                    </li>
                                    <!--{/demo}-->
                                </ul>
                            @else
